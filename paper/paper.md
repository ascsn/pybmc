...
Modern theoretical studies in nuclear physics - and increasingly in other areas of computational sciences such as public health, neuroscience, or engineering - often rely on combining a set of models that provide different predictions for the same observable. Combining these models in a statistically robust and uncertainty-quantified way remains a central challenge. Bayesian Model Combination (BMC) offers a useful framework to address this problem by constructing weighted predictions from multiple models using dimensionality reduction and Bayesian inference. 
Despite its conceptual appeal, practical application of BMC is limited by the lack of accessible and convenient software implementations. Existing scientific Python tools such as scikit-learn and PyMC provide components relevant to this workflow (e.g., dimensionality reduction and Bayesian inference), but they do not offer an integrated pipeline for model combination tasks. This software addresses this problem by providing an user-friendly, object-oriented framework for BMC, and is designed to streamline its application to nuclear physics datasets and beyond. It integrates key steps - data processing, dimensionality reduction (e.g., principal component analysis), and Bayesian statistical modeling - into a coherent and reusable workflow. By organizing these operations into modular components, the package enables fast and simultaneous implementation of BMC across different datasets, while allowing flexible selection or extension of different components in the workflow.
The target audience of this software includes researchers in nuclear physics and related computational sciences who seek an efficient implementation of model combination techniques. By lowering the technical barrier to implementing BMC, this software facilitates a broader adoption of uncertainty-quantified model combination methods to research across scientific disciplines.
